...
public class Algorithms {
    public static void floydAlgorithm(Integer[][] distanceMatrix) {
    ...
    public static void littleAlgorithm(Integer[][] matrix) {
        ...
        while (dimension != 2) {
            ...
            removeRowAndColumn(indexRow, indexColumn, distanceMatrix, dimension, availableRows, availableColumns);
            rewriteValue(indexRow, indexColumn, distanceMatrix, dimension, availableRows, availableColumns);
            dimension -= 1;
        }
    ...
    private static void removeRowAndColumn(
            int indexRow,
            int indexColumn,
            List<List<Integer>> distanceMatrix,
            int dimension,
    ...
    private static void rewriteValue(
            int indexRow,
            int indexColumn,
            List<List<Integer>> distanceMatrix,
            int dimension,
